...
sed -i 's#^\(\s*\)make #\1EMCC_CFLAGS="--use-port=sdl3 --use-port=sdl3_ttf -Wno-experimental -Wno-unused-template -I/tmp/sdl3_image_prefix/include" make PCH=0 #' build-scripts/build-emscripten.sh
