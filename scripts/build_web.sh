...
export LDFLAGS="$LDFLAGS --use-port=sdl3 --use-port=sdl3_ttf /tmp/sdl3_image_prefix/lib/libSDL3_image.a -sDEFAULT_TO_CXX -O2 -sASYNCIFY_STACK_SIZE=1048576 -sSTACK_SIZE=5MB"
