...
export LDFLAGS="$LDFLAGS --use-port=sdl3 --use-port=sdl3_ttf /tmp/sdl3_image_prefix/lib/libSDL3_image.a -sDEFAULT_TO_CXX -O0 -g0 -sASYNCIFY_STACK_SIZE=1048576 -sASSERTIONS=2"
